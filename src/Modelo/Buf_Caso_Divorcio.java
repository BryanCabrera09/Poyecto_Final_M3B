 ...
 */
public class Buf_Caso_Divorcio {
    ...
    public Buf_Caso_Divorcio(int id_caso, String cedula, byte[] req_1, byte[] req_2, byte[] req_3, byte[] req_4, byte[] req_5, byte[] req_6, double honorarios, String observacion) {
