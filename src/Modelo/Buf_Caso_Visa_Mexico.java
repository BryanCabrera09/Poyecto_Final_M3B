 ...
 */
public class Buf_Caso_Visa_Mexico {
    ...
    public Buf_Caso_Visa_Mexico(int id_caso, String cedula, byte[] req_1, byte[] req_2, byte[] req_3, byte[] req_4, byte[] req_5, double honorarios, int num_beneficiarios, String observacion) {
