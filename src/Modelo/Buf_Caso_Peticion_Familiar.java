 ...
 */
public class Buf_Caso_Peticion_Familiar {
    ...
    public Buf_Caso_Peticion_Familiar(int id_caso, String cedula, byte[] req_1, byte[] req_2, byte[] req_3, byte[] req_4, byte[] req_5, byte[] req_6, byte[] req_7, byte[] req_8, byte[] req_9, double honorarios, int num_beneficiarios, String observacion) {
    ...
    public Buf_Caso_Peticion_Familiar() {
    }
