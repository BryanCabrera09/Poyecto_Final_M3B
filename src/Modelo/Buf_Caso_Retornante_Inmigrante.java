 ...
 */
public class Buf_Caso_Retornante_Inmigrante {
    ...
    public Buf_Caso_Retornante_Inmigrante(int id_caso, String cedula, byte[] req_1, byte[] req_2, byte[] req_3, byte[] req_4, byte[] req_5, byte[] req_6, double honorarios, int num_beneficiarios, String observacion) {
