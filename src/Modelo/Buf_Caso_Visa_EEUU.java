 ...
 */
public class Buf_Caso_Visa_EEUU {
    ...
    public Buf_Caso_Visa_EEUU(int id_caso, String cedula, byte[] req_1, byte[] req_2, byte[] req_3, byte[] req_4, byte[] req_5, byte[] req_6, byte[] req_7, byte[] req_8, byte[] req_9, byte[] req_10, byte[] req_11, double honorarios, int num_beneficiarios, String observacion) {
