 ...
 */
public class Buf_Caso_Pension_Aliment {
    ...
    public Buf_Caso_Pension_Aliment(int id_caso, String cedula, byte[] req_1, byte[] req_2, byte[] req_3, byte[] req_4, byte[] req_5, byte[] req_6, double honorarios, String observacion) {
