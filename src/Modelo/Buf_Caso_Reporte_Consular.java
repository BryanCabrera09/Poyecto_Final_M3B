 ...
 */
public class Buf_Caso_Reporte_Consular {
    ...
    public Buf_Caso_Reporte_Consular(int id_caso, String cedula, byte[] req_1, byte[] req_2, byte[] req_3, byte[] req_4, byte[] req_5, byte[] req_6, byte[] req_7, byte[] req_8, double honorarios, int num_beneficiarios, String observacion) {
